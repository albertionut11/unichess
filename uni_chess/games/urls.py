...
urlpatterns = [
    ...
    path('games/play/', views.create_play, name='create_play'),
    path('games/play/<str:play_id>', views.PlayView.as_view(), name='game_play'),
    path('move_piece/<str:play_id>', views.move_piece, name='move_piece'),
